          ...
          <section className="post-full-content">
            <PostFullContent>
              <p>
                ...
                здесь тоже живут и работают люди. Мы тоже делаем классные вещи, пускай даже Саратов
                не самый лучший город на земле. Но даже здесь есть свои специалисты и инженеры.
              </p>
              <p>
                Идея названия «Build in Saratov» родилась неслучайно. Оно взято по аналогии с
                командой{' '}
                <a
                  target="_blank"
              ...
              <p>
                ...
                опытом. Когда отвечаешь на один и тот же вопрос в 10-ый раз, поневоле хочется
                написать статью и давать ссылки на неё.
              </p>
